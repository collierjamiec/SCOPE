...
const report: AuditReport = {
  ...
  sitemaps: [], redirects: [], brokenLinks: [], pages: [], excludedPages: [], keywords: [], cannibalization: [], aiCrawlerAccess: [], importedData: { gscRows: 0, ga4Rows: 0, gscKeywords: 0, ga4MatchedPages: 0 }, priorities: [], generatedAt: '2026-08-24T12:00:00.000Z'
};
